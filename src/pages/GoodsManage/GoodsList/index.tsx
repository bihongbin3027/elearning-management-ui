...
const GoodsMainList = () => {
  ...
  const editorExampleRef = useRef<any>() // 富文本实例
  ...
  /**
   * @Description 加载富文本编辑器
   * @Author bihongbin
   * @Date 2020-09-03 16:03:21
   */
  useEffect(() => {
    editorExampleRef.current = new E(editorDivRef.current)
    editorExampleRef.current.create()
  }, [])
