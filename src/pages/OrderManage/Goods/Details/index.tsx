        ...
        <Row className="modal-form-height" gutter={20}>
          <Col span={24}>
            <Space size={15} style={{ width: '100%' }}>
              <SxyBadge bg="#5860F8" />
              <span className="font-16 bold">商品信息</span>
            </Space>
            ...
            <div className="mt-5">
              <Space size={15} style={{ width: '100%' }}>
                <SxyBadge bg="#5860F8" />
                <span className="font-16 bold">用户信息</span>
              </Space>
              <div className="ml-6">
                <Row className="mt-2">
            ...
            <div className="mt-6">
              <Space size={15} style={{ width: '100%' }}>
                <SxyBadge bg="#5860F8" />
                <span className="font-16 bold">下单信息</span>
              </Space>
              <div className="ml-6">
                <Row className="mt-2">
            ...
            <div className="mt-6">
              <Space size={15} style={{ width: '100%' }}>
                <SxyBadge bg="#5860F8" />
                <span className="font-16 bold">付款方式</span>
              </Space>
              <div className="ml-6">
                <Row className="mt-2">
                  <Col className="text-desc" span={3}>
            ...
            <div className="mt-6">
              <Space size={15} style={{ width: '100%' }}>
                <SxyBadge bg="#5860F8" />
                <span className="font-16 bold">订单信息</span>
              </Space>
              <div className="ml-6">
                <Row className="mt-2">
                  <Col className="text-desc" span={3}>
            ...
            <div className="mt-6">
              <Space size={15} style={{ width: '100%' }}>
                <SxyBadge bg="#5860F8" />
                <span className="font-16 bold">发票信息</span>
              </Space>
              <div className="ml-6">
                <Row className="mt-2">
                  <Col span={8}>
            ...
            <div className="mt-6">
              <Space size={15} style={{ width: '100%' }}>
                <SxyBadge bg="#5860F8" />
                <span className="font-16 bold">配送信息</span>
              </Space>
              <div className="ml-6">
                <Row className="mt-2">
                  <Col className="text-desc" span={3}>
